...
{
    int n = 0;
void (*ptrFuncs[5])(Producto*)={funcionAumentar,
funcionDisminuir,funcionCalcularIGV,
funcionCambiarPrecioProducto,calcularValorProducto};
    ptrFuncs[opc+1](ptrProducto);
